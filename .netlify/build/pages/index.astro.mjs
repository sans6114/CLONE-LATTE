...
import { $ as $$MainLayout } from '../chunks/MainLayout_DORvV9SU.mjs';
...
const $$ButtonCompleting = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$b, $$props, $$slots);
  Astro2.self = $$ButtonCompleting;
  const { btnTitle, url } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<div class="mt-7 grid w-56 md:w-auto gap-3 sm:inline-flex border border-violet-500" data-astro-cid-vkjdby2a> <a${addAttribute(url, "href")} class="exampleClass font-bold text-neutral-800 dark:text-neutral-200 flex" data-astro-cid-vkjdby2a> <span data-astro-cid-vkjdby2a>${btnTitle}</span> <svg xmlns="http://www.w3.org/2000/svg" class="w-4 mx-2" viewBox="0 0 15 15" data-astro-cid-vkjdby2a><path fill="black" d="M8.293 2.293a1 1 0 0 1 1.414 0l4.5 4.5a1 1 0 0 1 0 1.414l-4.5 4.5a1 1 0 0 1-1.414-1.414L11 8.5H1.5a1 1 0 0 1 0-2H11L8.293 3.707a1 1 0 0 1 0-1.414" data-astro-cid-vkjdby2a></path></svg> </a> </div> `;
}, "C:/Users/PC/Desktop/LATTE-NETLIFY/astro-auth/src/components/ui/buttons/ButtonCompleting.astro", void 0);
...
const $$CategoryDivider = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="flex flex-col md:flex-row items-center w-full px-5"> ${categoria.right ? renderTemplate`<!-- Si \`right\` es true, muestra la imagen primero y luego el contenido -->
          ...
          <div class="shadow-xl rounded-sm flex flex-col items-center text-start md:w-1/4 md:mx-auto order-2 md:order-none"> <div class="card-body"> <h2 class="card-title">${categoria.title}</h2> <p>${categoria.subtitle}</p> <div class="w-56"> ${renderComponent($$result, "ButtonCompleting", $$ButtonCompleting, { "btnTitle": categoria.btnTitle, "url": categoria.btnUrl })} </div> </div> </div>` : renderTemplate`<!-- Si \`right\` es false, muestra el contenido primero y luego la imagen -->
          <div class="shadow-xl rounded-sm flex flex-col items-center text-start md:w-1/4  order-2 md:order-none"> <div class="card-body"> <h2 class="card-title">${categoria.title}</h2> <p>${categoria.subtitle}</p> <div class="w-56"> ${renderComponent($$result, "ButtonCompleting", $$ButtonCompleting, { "btnTitle": categoria.btnTitle, "url": categoria.btnUrl })} </div> </div> </div>
...
const $$CategoriasLatte = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="flex flex-col my-[150px]"> <div class="flex flex-col md:px-10 items-center gap-y-5 mb-10 text-center"> <h2 class="block text-balance text-3xl font-bold tracking-tight sm:text-4xl lg:text-6xl lg:leading-tight ">${title}</h2> <p class="mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 ">${subtitle}</p> </div> ${packsData.map((data) => renderTemplate`${renderComponent($$result, "CategoryDivider", $$CategoryDivider, { "categoria": data })}
...
const $$Divider = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="border border-violet-500 w-3/5 mx-auto my-10"></div>`;
}, "C:/Users/PC/Desktop/LATTE-NETLIFY/astro-auth/src/components/ui/utils/Divider.astro", void 0);

const $$ChatItem = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="relative mx-auto border-gray-800  bg-gray-800 border-[14px] rounded-[2.5rem] h-[600px] w-[300px] shadow-xl mt-[100px]"> <div class="w-[148px] h-[18px] bg-gray-800 top-0 rounded-b-[1rem] left-1/2 -translate-x-1/2 absolute"></div> <div class="h-[46px] w-[3px] bg-gray-800 absolute -start-[17px] top-[124px] rounded-s-lg"></div> <div class="h-[46px] w-[3px] bg-gray-800 absolute -start-[17px] top-[178px] rounded-s-lg"></div> <div class="h-[64px] w-[3px] bg-gray-800 absolute -end-[17px] top-[142px] rounded-e-lg"></div> <div class="rounded-[2rem] overflow-hidden w-[272px] h-[572px] bg-white"> <div class="absolute bottom-0 p-5"> <div class="chat chat-start"> <div class="chat-image avatar"> <div class="w-10 rounded-full"> <img alt="avatar chat wsp" src="https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.webp"> </div> </div> <div class="chat-bubble">It was said that you would, destroy the Sith, not join them.</div> </div> <div class="chat chat-start"> <div class="chat-image avatar"> <div class="w-10 rounded-full"> <img alt="avatar chat wsp" src="https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.webp"> </div> </div> <div class="chat-bubble">It was you who would bring balance to the Force</div> </div> <div class="chat chat-start"> <div class="chat-image avatar"> <div class="w-10 rounded-full"> <img alt="avatar chat wsp" src="https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.webp"> </div> </div> <div class="chat-bubble">Not leave it in Darkness</div> </div> </div> </div> </div>`;
...
const $$HeroSection = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<!-- Defining a grid container that holds all the content -->${maybeRenderHead()}<section class="mx-auto grid max-w-[85rem] gap-4 px-4 py-14 sm:px-6 md:grid-cols-2 md:items-center md:gap-8 lg:px-8 2xl:max-w-full"> <!-- Title and description --> <div> <!-- Each h1 and p tag renders a portion of the title and subTitle defined above --> <h1 class="block text-balance text-3xl font-bold tracking-tight sm:text-4xl lg:text-6xl lg:leading-tight"> <!-- About Fragment: https://docs.astro.build/en/basics/astro-syntax/#fragments --> ${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate`${unescapeHTML(title)}` })} </h1> ${subTitle && renderTemplate`<p class="mt-3 text-pretty text-lg leading-relaxed  lg:w-4/5"> ${subTitle} </p>`} <!-- Action Button Section: This section includes two CTAs with their own styles and URL --> ${renderComponent($$result, "ButtonCompleting", $$ButtonCompleting, { "btnTitle": primaryBtn, "url": primaryBtnURL })} <!-- Review Section: This section presents avatars, review ratings and the number of reviews --> </div> <!-- Hero Image Section --> <div class="flex w-full"> <div class="top-12 overflow-hidden"> ${src && alt && renderTemplate`${renderComponent($$result, "Image", $$Image, { "src": src, "alt": alt, "class": "h-full w-full scale-110 object-cover object-center", "draggable": "false", "loading": "eager", "format": "avif" })}`} </div> </div> </section>`;
...
const $$CardIndex = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="h-[250px] md:h-auto card bg-base-100 shadow-xl focus-visible:scale-125 md:hover:scale-125 hover:z-40 transition-all duration-100 ease-in-out rounded-3xl"> <figure> <img${addAttribute(card.imgCard, "src")}${addAttribute(card.alt, "alt")} class="h-full md:h-96 w-full object-cover object-center rounded-3xl"${addAttribute("false", "draggable")}${addAttribute("eager", "loading")}> </figure> <div class="card-body absolute inset-0 flex flex-col justify-center items-center bg-opacity-75 bg-white text-center opacity-0 transition-opacity duration-300 ease-in-out hover:opacity-100 rounded-3xl"> <h2 class="card-title">${card.CardTitle}</h2> <p>${card.subCard}</p> </div> </div>`;
...
const cardData = [
    {
      ...
      imgCard: "https://img.daisyui.com/images/stock/photo-1606107557195-0e29a4b5b4aa.webp",
