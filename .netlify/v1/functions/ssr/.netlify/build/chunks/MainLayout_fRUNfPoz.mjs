import { c as createComponent, r as renderTemplate, m as maybeRenderHead, d as renderComponent, a as addAttribute, f as renderSlot, b as createAstro } from './astro/server_DxybiuS0.mjs';
import 'kleur/colors';
import 'clsx';
import { f as firebase } from './config_COeD87Ye.mjs';
/* empty css                         */

const $$LatteLogo = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<!-- Generator: Adobe Illustrator 24.1.2, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->${maybeRenderHead()}<svg class="w-[80px] md:w-[100px]" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 595.28 549.02" style="enable-background:new 0 0 595.28 549.02;" xml:space="preserve"> <style type="text/css">
...
}, "C:/Users/PC/Desktop/LATTE-NETLIFY/astro-auth/src/icons/logos/LatteLogo.astro", void 0);

const $$SelectThemeChange = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<select data-choose-theme class="select select-primary w-10 md:w-[200px] mx-0 md:mx-4"> <option value="">Default</option> <option value="light">Light</option> <option value="dark">Dark</option> <option value="cupcake">Cupcake</option> <option value="bumblebee">Bumblebee</option> <option value="emerald">Emerald</option> <option value="corporate">Corporate</option> <option value="synthwave">Synthwave</option> <option value="retro">Retro</option> <option value="cyberpunk">Cyberpunk</option> <option value="valentine">Valentine</option> <option value="halloween">Halloween</option> <option value="garden">Garden</option> <option value="forest">Forest</option> <option value="aqua">Aqua</option> <option value="lofi">Lofi</option> <option value="pastel">Pastel</option> <option value="fantasy">Fantasy</option> <option value="wireframe">Wireframe</option> <option value="black">Black</option> <option value="luxury">Luxury</option> <option value="dracula">Dracula</option> <option value="cmyk">CMYK</option> <option value="autumn">Autumn</option> <option value="business">Business</option> <option value="acid">Acid</option> <option value="lemonade">Lemonade</option> <option value="night">Night</option> <option value="coffee">Coffee</option> <option value="winter">Winter</option> <option value="dim">Dim</option> <option value="nord">Nord</option> <option value="sunset">Sunset</option> </select>`;
}, "C:/Users/PC/Desktop/LATTE-NETLIFY/astro-auth/src/components/ui/themechange/SelectThemeChange.astro", void 0);

const menuData = [
    {link:"/", content:"Inicio", isUserRoute: false},
    {link:"/nosotros", content:"Nosotros", isUserRoute: false},
    {link:"/productos", content:"Productos", isUserRoute: false},
    {link:"/inicio", content:"Inicio", isUserRoute: true},
    {link:"/beneficios", content:"Beneficios", isUserRoute: true},
    {link:"/contacto", content:"Contacto", isUserRoute: true},
    {link:"/mi-cuenta", content:"Mi cuenta", isUserRoute: true},
];
...
const $$Navbar = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<header class="fixed inset-x-0 top-0 z-50 flex justify-around bg-base-200 my-6 mx-auto w-5/6  rounded-full shadow-2xl border-2 border-base-300 mb-10 p-1 md:p-2 bg-opacity-70 backdrop-blur-md" <nav class="relative navbar border "> <div class="navbar-start"> <div class="dropdown"> <div tabindex="0" role="button" class="btn btn-ghost btn-circle mx-4"> ${renderComponent($$result, "LatteLogo", $$LatteLogo, {})} </div> <ul tabindex="0" class="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow"> <li class="text-center"> ${routes.map(({ link, content }) => renderTemplate`<div class="btn btn-primary btn-outline my-2"> <a${addAttribute(link, "href")} class="block py-2 px-3 w-full text-start" aria-current="page"> ${content} </a> </div>`)} </li> </ul> </div> </div> <div class="navbar-center"></div> <div class="navbar-end flex mx-4"> ${renderComponent($$result, "SelectThemeChange", $$SelectThemeChange, {})} <!-- {
      user ? (
...
}, "C:/Users/PC/Desktop/LATTE-NETLIFY/astro-auth/src/components/shared/Navbar.astro", void 0);

const $$FooterSection = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<footer class="footer text-neutral-content p-10 border-t rounded-t-3xl border-primary flex"> <aside> ${renderComponent($$result, "LatteLogo", $$LatteLogo, {})} <p class="text-black text-sm">
Latte chocolate porducción.
<br> </p><p class="text-black text-sm">© <span id="year"></span> Latte chocolate. Todos los derechos reservados.</p>  </aside> <nav class="md:ml-auto"> <h6 class="footer-title text-black">Seguinos</h6> <div class="grid grid-flow-col gap-4"> <a class="cursor-pointer" href="https://www.instagram.com/latteechocolate/?hl=es"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="black" d="M7.8 2h8.4C19.4 2 22 4.6 22 7.8v8.4a5.8 5.8 0 0 1-5.8 5.8H7.8C4.6 22 2 19.4 2 16.2V7.8A5.8 5.8 0 0 1 7.8 2m-.2 2A3.6 3.6 0 0 0 4 7.6v8.8C4 18.39 5.61 20 7.6 20h8.8a3.6 3.6 0 0 0 3.6-3.6V7.6C20 5.61 18.39 4 16.4 4zm9.65 1.5a1.25 1.25 0 0 1 1.25 1.25A1.25 1.25 0 0 1 17.25 8A1.25 1.25 0 0 1 16 6.75a1.25 1.25 0 0 1 1.25-1.25M12 7a5 5 0 0 1 5 5a5 5 0 0 1-5 5a5 5 0 0 1-5-5a5 5 0 0 1 5-5m0 2a3 3 0 0 0-3 3a3 3 0 0 0 3 3a3 3 0 0 0 3-3a3 3 0 0 0-3-3"></path></svg> </a> <a class="cursor-pointer" href="#"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="black" d="M16.6 5.82s.51.5 0 0A4.28 4.28 0 0 1 15.54 3h-3.09v12.4a2.59 2.59 0 0 1-2.59 2.5c-1.42 0-2.6-1.16-2.6-2.6c0-1.72 1.66-3.01 3.37-2.48V9.66c-3.45-.46-6.47 2.22-6.47 5.64c0 3.33 2.76 5.7 5.69 5.7c3.14 0 5.69-2.55 5.69-5.7V9.01a7.35 7.35 0 0 0 4.3 1.38V7.3s-1.88.09-3.24-1.48"></path></svg> </a> <a class="cursor-pointer" href="https://www.facebook.com/p/Latte-Chocolate-100063782032795/?locale=es_LA"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="black" d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c5.05-.5 9-4.76 9-9.95"></path></svg> </a> </div> </nav> </footer> `;
}, "C:/Users/PC/Desktop/LATTE-NETLIFY/astro-auth/src/components/shared/FooterSection.astro", void 0);
...
const $$MainLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="es" data-astro-cid-ouamjn2i> <script>\n    if (localStorage.getItem("theme") === null) {\n      document.documentElement.setAttribute("data-theme", "light");\n    } else {\n      document.documentElement.setAttribute(\n        "data-theme",\n        localStorage.getItem("theme") ?? ""\n      );\n    }\n  <\/script><meta charset="UTF-8"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="viewport" content="width=device-width"><meta name="generator"', "><title>", "</title>", '<body data-astro-cid-ouamjn2i> <div class="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8" data-astro-cid-ouamjn2i> ', ' <main class="min-h-screen mt-12" data-astro-cid-ouamjn2i> ', " </main> </div> ", "  </body> </html>"])), addAttribute(Astro2.generator, "content"), title, maybeRenderHead(), renderComponent($$result, "Navbar", $$Navbar, { "data-astro-cid-ouamjn2i": true }), renderSlot($$result, $$slots["default"]), renderComponent($$result, "FooterSection", $$FooterSection, { "data-astro-cid-ouamjn2i": true }));
}, "C:/Users/PC/Desktop/LATTE-NETLIFY/astro-auth/src/layouts/MainLayout.astro", void 0);
