import { c as callSafely, a as ActionError, b as ActionInputError, d as getApiContext$1 } from './shared_Dgvkitwq.mjs';
...
async function actionHandler(param, path) {
  {
    const { getAction } = await import('./shared_Dgvkitwq.mjs').then(n => n.u);
